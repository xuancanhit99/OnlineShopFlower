		...
		<div class="product-info text-left">
			...
			<div class="product-price">
				<span class="price">
					...
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i>Добавить в корзину </a></div>
			</div><!-- /.product -->
