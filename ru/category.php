...
<?php include('includes/top-header.php');?>
    <div class="container">
        <button type="button"><a href="../category.php?cid=<?php echo $cid; ?>">EN</a></button>
    </div>
<!-- ============================================== TOP MENU : END ============================================== -->
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<button class="btn btn-primary" type="button"><i class="fa fa-shopping-cart inner-right-vs"></i>Добавить в корзину </button></a>
