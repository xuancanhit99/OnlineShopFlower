...
if (strlen($_SESSION['login']) == 0) {
    ...
    <header class="header-style-1">
        ...
        <div class="container">
            <button type="button"><a href="../my-account.php">EN</a></button>
        </div>
        <!-- ============================================== TOP MENU : END ============================================== -->
                                            ...
                                            <div class="col-md-12 col-sm-12 already-registered-login">
                                                ...
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ...
                                                    <form class="register-form" role="form" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="info-title" for="exampleInputEmail1">Почта
                                                                <span>*</span></label>
                                                            <input type="email"
                                                                   class="form-control unicase-form-control text-input"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="info-title" for="Contact No.">Номер телефона
                                                                <span>*</span></label>
                                                            <input type="text"
                                                                   class="form-control unicase-form-control text-input"
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <form class="register-form" role="form" method="post" name="chngpwd"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Current Password">Старый
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Confirm Password">Подтвердите пароль
                                                    <span>*</span></label>
                                                <input type="password"
