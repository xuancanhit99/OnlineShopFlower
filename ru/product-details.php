...
{
//mysqli_query($con,"INSERT INTO wishlist(productId, userId) values('$pid', '".$_SESSION['id']."')");
    mysqli_query($con,
        "INSERT INTO wishlist (productId,userId)
SELECT * FROM (SELECT '$pid' AS productId, '".$_SESSION['id']."' AS userId) AS temp
WHERE NOT EXISTS (
    SELECT productId FROM wishlist WHERE productId = '$pid'
) LIMIT 1;");
...
<?php include('includes/top-header.php');?>
    <div class="container">
        <button type="button"><a href="../product-details.php?pid=<?php echo $pid; ?>">EN</a></button>
    </div>
<!-- ============================================== TOP MENU : END ============================================== -->
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									<?php echo htmlentities($rws['productPrice']);?> Руб.00
								</span>
									
							    <span class="price-before-discount"><?php echo htmlentities($rwsCATEGORY['productPriceBeforeDiscount']);?>Руб.</span>
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="lnk btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i>Добавить в корзину </a>
...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">(<?php echo htmlentities($num);?> Отзыв)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10">
											<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Wishlist" href="product-details.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist">
                                                <?php
                                                $t = $row['id'];
                                                $result = mysqli_query($con,"SELECT id FROM wishlist WHERE productId = '$t'");
                                                if($result->num_rows == 0) {
                                                    echo '<span style="color: Chartreuse;"><i class="fa fa-heart"></i></span>';
                                                } else {
                                                    echo '<span style="color: Tomato;"><i class="fa fa-heart"></i></span>';
                                                }
                                                ?>
											</a>
										</div>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Значение :</b>  <?php echo htmlentities($rvw['value']);?> звезда</div>
												...
												<div class="table-responsive">
													<table class="table table-bordered">	
														...
														<tbody>
															...
															<tr>
																<td class="cell-label">Значение</td>
