...
<?php include('includes/top-header.php');?>
    <div class="container">
        <button type="button"><a href="./ru/product-details.php?pid=<?php echo $pid; ?>">RU</a></button>
    </div>
<!-- ============================================== TOP MENU : END ============================================== -->
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
							    ...
							    <span class="price-before-discount"><?php echo htmlentities($rws['productPriceBeforeDiscount']);?>Rub</span>
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="lnk btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i>Add to cart</a>
